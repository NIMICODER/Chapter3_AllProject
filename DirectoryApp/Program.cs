...
namespace DirectoryApp
{
    internal class Program
    {
        ...
        static void FunWithDirectoryType()
        {
            ...
            try
            {
                Directory.Delete("MyFolderIsHere");
        ...
        static void ShowWindowsDirectoryInfoB()
        {
            // Dump directory information. If you are not on Windows, plug in another directory
            DirectoryInfo dir = new DirectoryInfo($@"C:\Users\HP\Downloads");
            Console.WriteLine("***** Directory Info *****");
            Console.WriteLine("FullName: {0}", dir.FullName);
            Console.WriteLine("Name: {0}", dir.Name);
            Console.WriteLine("Parent: {0}", dir.Parent);
        ...
        static void DisplayImageFiles()
        {
           ...
           DirectoryInfo($@"C:\Users\HP\Downloads");
        ...
        {
            DirectoryInfo dir = new DirectoryInfo($@"C:\Users\HP\source\repos");
            // Create \MyFolder off application directory.
            dir.CreateSubdirectory("EmptyRepoHere");
            // Create \MyFolder2\Data off application directory.
            dir.CreateSubdirectory(
            $@"EmptyRepoHere2{Path.DirectorySeparatorChar}Data");
        }

        static void ModifyAppDirectoryB()
        {
            DirectoryInfo dir = new DirectoryInfo($@"C:\Users\HP\source\repos");
            // Create \MyFolder off initial directory.
            dir.CreateSubdirectory("MyFolderIsHere");
